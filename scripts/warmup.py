...
USAGE:
    # Run standalone warmup (uses OLLAMA_MODEL env var or defaults to llama3:8b)
    python warmup.py

    # Use specific model
    OLLAMA_MODEL=llama3.2:3b python warmup.py
...
CONFIGURATION:
    - OLLAMA_MODEL: Set via environment variable (default: llama3:8b)
"""
...
# Use environment variable OLLAMA_MODEL if set, otherwise default to llama3:8b
# This matches the devcontainer.json configuration and lab scripts
